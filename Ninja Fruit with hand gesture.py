...
w=h=0
#heart_img = cv2.imread("heart.png")
#heart_img = cv2.resize(heart_img,(50,50))
...
def Spawn_Fruits(Rate):
    #if next_Time_to_Spawn > time.time():
    fruit = {}
    random_x = random.randint(15,600)
    #random_y = random.randint(40,440)
...
#*****************************************************************************
   ...
   # print(time.time())
    ...
    #cv2.circle(img,(600,440),Fruit_Size,(255,255,255),-1)
    #cv2.circle(img,(40,40),Fruit_Size,(255,255,255),-1)
    prev_Frame = curr_Frame

    #***********************************************************
    if not (game_Over):
        if  (time.time() > next_Time_to_Spawn): #and not (game_Over):
            Spawn_Fruits(Spawn_Rate)
